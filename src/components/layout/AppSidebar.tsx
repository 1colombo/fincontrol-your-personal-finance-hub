    ...
    <Sidebar className="border-r-0">
      <SidebarHeader className="p-4 border-b border-sidebar-border">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-display font-bold text-lg text-sidebar-foreground">FinControl</h1>
        ...
        <div className="mb-6">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                className="w-full justify-between h-12 px-3 bg-sidebar-accent hover:bg-sidebar-accent/80 text-sidebar-accent-foreground rounded-lg"
              >
                <div className="flex items-center gap-3">
                  <div 
                    className="w-8 h-8 rounded-lg flex items-center justify-center text-sm font-semibold text-sidebar-primary-foreground"
                    style={{ backgroundColor: selectedProfile?.color || '#0891b2' }}
                  >
            ...
            <DropdownMenuContent align="start" className="w-56">
              {profiles.map((profile) => (
                ...
                >
                  <div 
                    className="w-6 h-6 rounded-md flex items-center justify-center text-xs font-semibold text-white mr-2"
      ...
      <SidebarFooter className="p-4 border-t border-sidebar-border">
        ...
        <Button
          ...
          className="w-full justify-start gap-3 text-sidebar-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground mb-2"
        >
          {theme === 'dark' ? (
            <>
        ...
        <div className="flex items-center justify-between p-2 rounded-lg bg-sidebar-accent">
          ...
          <Button
            ...
            size="icon"
            onClick={signOut}
            className="h-8 w-8 text-sidebar-muted hover:text-sidebar-foreground hover:bg-sidebar-border"
          >
